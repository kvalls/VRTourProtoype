...
var AVideoPlayer = function() {
    ...
    this._addControlsEvent = function() {
        ...
        this.elControlPlay.addEventListener('mouseenter', function() {
        ...
        this.elControlVolume.addEventListener('mouseenter', function() {
            that._playAudioAlert();
        ...
        this.elControlBack.addEventListener('mouseenter', function() {
            that._playAudioAlert();
    ...
    this._addProgressEvent = function() {
        var that = this;
        this.elProgressBar.addEventListener('mouseenter', function(e) {
    ...
    this._mobileFriendly = function() {
        if (AFRAME.utils.device.isMobile()) {
            ...
            video_permission_button.addEventListener("mouseenter", function() {
